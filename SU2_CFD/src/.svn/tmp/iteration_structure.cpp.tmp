...
/* This file is called from SU2_CFD.cpp, it sets up the outer loop iteration for the various physical problems
 * SU2 solves. For example, the method MeanFlowIteration sets up the outer loop iteration for the Euler and Navier-Stokes equations.
 *
 */
